...
function App() {
  return (
    <div className='bg-slate-700 text-cyan-50 h-screen'>
      <h1 className='flex items-center justify-center text-4xl pt-20'>Accordion React</h1>
      <Accordion
        items={[
          {
          ...
          { title: "How do I see GitHub's availability?", content: '-  Check our real-time status report' },
